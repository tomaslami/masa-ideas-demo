const { Sidebar, Button, IconButton, SegmentedControl, StatusPill, Icon, ImportDialog, EmptyState } = window.DesignSystem_27db72;
const { MapView, InventoryPanel } = window;
  ...
  return (
    <div style={{ display: 'flex', width: '100vw', height: '100vh', overflow: 'hidden', background: 'var(--bg-page)' }}>
      <Sidebar
        ...
        items={NAV} active="inventario" onSelect={() => {}}
        ...
        {view === 'mapa' ? (
          <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
            <div style={{ flex: 1, position: 'relative', minWidth: 0 }}>
              <MapView mapSrc="./assets/ba-map.png" items={all} selected={selected}

...
import { Icon, Input, Select, Button, IconButton, StatusPill } from '@/ds';
    ...
    <div style={{ maxWidth: 1000, margin: '0 auto' }}>
      ...
      {sel.length === 0 ? (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 18 }}>
          {sel.map((b) => (
            <BillboardPreview key={b.id} b={b} creative={creatives[b.id]} onCreative={setCreative} />
          ))}
        </div>
      )}
    </div>
...
export { Stepper, StepCliente, StepCarteles, StepCreatividad, StepCondiciones };
